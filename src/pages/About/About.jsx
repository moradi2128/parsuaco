          ...
          <BoxLeftBlogWrapper>
            <BlogSection title="Our company story " number="1">
              ...
              <TextContainer className="line-top">
                ...
                <p>
                  For more than a decade; It has started its activity in various
                  sectors such as providing technical engineering services,
                  supplying casting raw materials and mineral raw materials by
                  using experienced and specialized personnel. More than a
                  decade of experience and experience in the industry; This
                  group has become a stronghold for customers to supply raw
                  materials and equipment. This group always tries to keep its
                  customers at the highest quality and quantity level with the
                  slogan of "the power of a good choice". One of the plans for
                  this complex is to set up a production unit for ceramic parts
                  and dry mortar to expand its activity level. Customers have
                  always played an important role in the planning of this
                  collection. This is why this collection has used all its power
                  for maximum customer satisfaction. Therefore, we hope to be
                  able to always be with our good customers in the coming
                  years.This is why this collection has used all its power for
                  maximum customer satisfaction. Therefore, we hope to be able
                  to always be with our good customers in the coming years. Our
                  group consists of three companies named Parsua Sanat
                  Khavarmianeh, Parsua Faravar Iranian and Naqshineh Memari
                  Aria. Each of our companies is active in their own fields and
                  are ready to serve our dear customers.
                </p>
              </TextContainer>
            </BlogSection>
            {/* === Contact Details === */}

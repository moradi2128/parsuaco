...
import img2 from "../../assets/images/home/3.jpg";
// === Components ===
              ...
              <BlogSection title="Export & Import " number="1">
                ...
                <TextContainer className="line-top">
                  ...
                  <p>
                    ...
                    diplomacy and foreign policy between;governments is to
                    foster economic trade, encouraging exports and imports for
                    the benefit of all trading;parties.
                  </p>
                  <p>
                    According to research firm Statista, in 2019, the world’s
                    largest exporting countries (in terms of dollars) were
                    China, the United States, Germany, The Netherlands, and
                    Japan.1﻿ China posted exports of approximately $2.5 trillion
                    in goods, primarily electronic equipment, and machinery. The
                    United States exported approximately $1.6 trillion,
                    primarily capital goods. Germany's exports, which come to
                    approximately $1.5 trillion, were dominated by motor
                    vehicles—as were Japan's, which totaled approximately $705
                    billion. Finally, The Netherlands had exports of
                    approximately $709 billion.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    governments are trying to provide Bringing suitable
                    conditions for the import process to meet the needs of their
                    community. Therefore, in general, it can be said that the
                    import of goods is an important need recognized in different
                    societies and policymakers and governments of each country
                    are obliged to consider an appropriate response to this
                    vital need, so by formulating laws and creating appropriate
                    conditions for Carrying out the process of importing goods
                    They try to help traders and merchants in accelerating the
                    process of processes related to importing goods.
                  </p>
                </TextContainer>
              </BlogSection>
              <BlogSection title="Import & Export" number="2">
                <ImgContainer>
                  <Img src={img2} alt="export & import" loading="lazy" />
                  <ImgDes>
                    <ul>
                      <Li>
                        <strong>01 .</strong>
